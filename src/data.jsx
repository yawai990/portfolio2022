...
export const NavLinks = [
    ...
    { id: 2, name: 'about', icon: <SiAboutdotme /> },
    { id: 3, name: 'skills', icon: <GiSkills /> },
    { id: 4, name: 'projects', icon: <AiOutlineProject /> },
    { id: 5, name: 'contact', icon: <MdOutlineConnectWithoutContact /> }
];
